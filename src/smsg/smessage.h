...
#ifndef DYNAMIC_SMSG_SMESSAGE_H
#define DYNAMIC_SMSG_SMESSAGE_H
...
public:
    ...
    int ImportPrivkey(const CDynamicSecret &vchSecret, const std::string &sLabel);
